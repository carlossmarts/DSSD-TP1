...
//		System.out.println(bo.getByCodigoMedicamento("PAA-11111-5"));
		...
		Medicamento m = bo.getByCodigoMedicamento("PAA-11111-5");
		System.out.println(m);
